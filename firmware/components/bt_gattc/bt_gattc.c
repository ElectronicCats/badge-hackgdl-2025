...
void ble_client_gattc_event_handler(esp_gattc_cb_event_t event,
  ...
  case ESP_GATTC_CONNECT_EVT: {
    ...
    esp_log_buffer_hex(TAG_BT_GATTC,
...
void ble_client_esp_gap_cb(esp_gap_ble_cb_event_t event,
  ...
  case ESP_GAP_BLE_SCAN_RESULT_EVT: {
    ...
    case ESP_GAP_SEARCH_INQ_RES_EVT:
      ...
      ESP_LOGI(TAG_BT_GATTC, "searched Adv Data Len %d, Scan Response Len %d",
      ...
      if (adv_name != NULL) {
        if (strlen(remote_device_name) == adv_name_len &&
          ...
          ESP_LOGI(TAG_BT_GATTC, "searched device %s %d", remote_device_name,
...
void ble_client_esp_gattc_cb(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if,
                             esp_ble_gattc_cb_param_t *param) {
