...
void i2c_master_init(oled_driver_t *dev, int16_t sda, int16_t scl,
                     int16_t reset);
void i2c_init(oled_driver_t *dev, int width, int height);
void i2c_display_image(oled_driver_t *dev, int page, int seg, uint8_t *images,
                       int width);
...
void spi_master_init(oled_driver_t *dev, int16_t GPIO_MOSI, int16_t GPIO_SCLK,
...
bool spi_master_write_data(oled_driver_t *dev, const uint8_t *Data,
                           size_t DataLength);
void spi_init(oled_driver_t *dev, int width, int height);
void spi_display_image(oled_driver_t *dev, int page, int seg, uint8_t *images,
                       int width);
